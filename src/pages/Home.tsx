    ...
    <div className="min-h-screen dark">
      ...
      <div className="w-full bg-gradient-to-r from-navy via-gold/20 to-navy border-b border-gold/30 overflow-hidden py-2">
        <div className="flex items-center">
          ...
          >
            {[...Array(6)].map((_, i) => (
              <span key={i} className="flex items-center gap-3 text-gold font-semibold text-sm tracking-widest uppercase">
                <span className="w-1.5 h-1.5 rounded-full bg-gold inline-block" />
                carpet home
                <span className="text-white/60 mx-1">/</span>
                <span className="text-white font-bold">بيت السجاد</span>
                <span className="w-1.5 h-1.5 rounded-full bg-gold inline-block" />
              </span>
            ))}
          </motion.div>
      ...
      <a
        href="https://wa.me/905550200911"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-24 left-6 w-14 h-14 bg-green-500 hover:bg-green-400 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 z-50 transition-all hover:scale-110"
        aria-label="واتساب"
      >
